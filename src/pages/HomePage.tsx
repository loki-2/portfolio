...
export function HomePage() {
  ...
  return (
    <>
      {/* Splash intro renders on top; once done the layout reveals */}
      <SplashIntro onComplete={() => setSplashDone(true)} />

      {/*
        The main layout sits behind the splash overlay.
        It's invisible until the splash slides away so content
        (images, project cards) can pre-load during the ~2.6s intro.
      */}
      <motion.div
        ref={contentRef}
        initial={{ opacity: 0 }}
